    ...
    column(width = 12,
           box(collapsible = TRUE,
               ...
               column(width = 12,
                      ...
                      column(width = 2,
                        downloadButton("dl.KEGG_pathway", "Download")
                      )
               )
           )
    )
    ...
    column(width = 12,
      box(collapsible = TRUE,
        title = span(icon("th-list"),"Enrichment results - GSEA"), status = "primary", width = NULL,
          ...
          column(width = 2,
               downloadButton("dl.KEGG_GSEA", "Download")
        )
      ),
      ...
      box(collapsible = TRUE,
        ...
        column(width = 3,
          ...
          downloadButton("dl.KEGG_dotPlotGSEA", "Download")
        ),
        column(width = 9,
    ...
    column(width = 12,
      box(collapsible = TRUE,
        ...
        column(width = 2,
          ...
          downloadButton("dl.KEGG_ridgeGSEA", "Download")
        ),
        column(width = 10,
    ...
    column(width = 12,
      box(collapsible = TRUE,
        ...
        column(width = 12,
          ...
          column(width = 2,
                 downloadButton("dl.KEGG_pathwayGSEA", "Download")
          )
          )
        )
    )
